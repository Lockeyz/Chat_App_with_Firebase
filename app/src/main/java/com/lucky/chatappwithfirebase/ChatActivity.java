...
public class ChatActivity extends AppCompatActivity {
    ...
    void callApi(JSONObject jsonObject){
        ...
        Request request = new Request.Builder()
                .url(url)
                .post(body)
                .header("Authorization", "Bearer AAAACTyZB6U:APA91bHU3t_1CFvEKwvctc0H3_u27Ud7z8_U0SNZrtxHVokjaWGSwplwc7l-DgH0qrNn0SPRG7oU8MWE3oYWVDh2Gy6O7wOPguupeVy1dIkbY0-OYUaG_ncidC2aSmEnotk2K7gYPJx8")
                .build();
